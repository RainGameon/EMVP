...
def my_main(_run, _config, _log):
    ...
    print('SUNMENGYAO________________________start my_main')
...
if __name__ == '__main__':
    ...
    # print('SUNMENGYAO______________'+os.path.join(os.path.dirname(__file__), "config", "default.yaml"))
    ...
    # print('SUNMENGYAO____________config_dict',config_dict)
    
    

    # now add all the config to sacred
    ex.add_config(config_dict)
    # print('SUNMENGYAO____________add_config')
    # Save to disk by default for sacred
    logger.info("Saving to FileStorageObserver in results/sacred.")
    file_obs_path = os.path.join(results_path, "sacred")
    print('SUNMENGYAO____________results_path='+results_path)
    ex.observers.append(FileStorageObserver.create(file_obs_path))
    print('SUNMENGYAO____________start run')
    # ex.run()方法来触发实验的执行，并自动调用被"@ex.main"装饰的主函数。
